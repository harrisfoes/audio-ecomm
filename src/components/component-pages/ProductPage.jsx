      ...
      <section className="section-container">
        <div className="mx-auto w-[90%] pt-4">
          ...
          <div className="product-card">
            <div className="pt-4">
              <img src={baseUrl + productDetails.image.mobile.slice(1)} />
            </div>
            <div>
              <div className="productText py-2">
                ...
                <p className="pt-4 opacity-50">{productDetails.description}</p>
              </div>
          ...
          <div className="gallery">
            <img
              ...
              src={baseUrl + productDetails.gallery.first.mobile.slice(1)}
            />
            <img
              className="my-3 rounded-lg"
              src={baseUrl + productDetails.gallery.second.mobile.slice(1)}
            />
            <img
              className="my-3 rounded-lg"
              src={baseUrl + productDetails.gallery.third.mobile.slice(1)}
            />
          </div>
