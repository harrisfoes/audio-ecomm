...
function Cart() {
  ...
  return (
    <>
      <div onClick={toggleMenu} className="cursor-button relative">
        <img
          src={CartImage}
          alt="cart-image"
      ...
      {isOpen && (
        <>
          ...
          <div className="absolute inset-0 mx-auto  xl:max-w-[1100px]">
            <div className="cart-items-component  absolute left-0 top-28 z-50 mx-6 w-[85%] max-w-[400px] rounded-lg bg-neutral-000 p-5 md:left-auto md:right-0">
